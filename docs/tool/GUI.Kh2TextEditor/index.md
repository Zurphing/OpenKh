...
| 15   | {:chardelay ProgramID} | Used on text that precedes selectable options that teleport the player to fights, like Absent Silhouettes. The Program ID specifies a specific fight to warp into, otherwise 0x33 will serve as a "cancel" option to exit out of the textbox.
